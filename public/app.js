...
function renderProducts(){
 ...
 $('#products').innerHTML=arr.map(p=>{const c=cat(p.category_id||p.categoryId),image=displayImage(p),canOrder=p.orderable!==false,origin=photoOrigin(p);return `<article class="product-card ${canOrder?'':'market-card'} ${origin.cls}-photo">
